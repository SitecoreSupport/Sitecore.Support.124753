...
using FieldEditorOptions = Sitecore.Shell.Applications.ContentManager.FieldEditorOptions;

namespace Sitecore.Support.Shell.Applications.ContentManager
{
    /// <summary>
    /// Defines the field editor form class.
    /// </summary>
    public class FieldEditorForm : BaseEditorForm
    {
        /// <summary>
        /// The validators key.
        /// </summary>
        ...
        /// The options.
        /// </value>
        protected FieldEditorOptions Options
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Gets or sets the validators key.
        /// </summary>
        /// <value>
        /// The validators key.
        /// </value>
        ...
        protected Sitecore.Data.Validators.ValidatorCollection BuildValidators(ValidatorsMode mode)
        {
            ...
            return ValidatorManager.BuildValidators(mode, this.ValidatorsKey, this.Options.Fields, database, safeDictionary);
        }
        ...
        protected override void OnLoad(System.EventArgs e)
        {
            ...
            this.Options = FieldEditorOptions.Parse(new UrlString(WebUtil.GetQueryString()));
